...
let description = (d, pDescr, td4one, td4due) => {
...
let displayResults = (data) => {
  ...
  if (data.length) {
    ...
    data.forEach((d) => {
      ...
      description(d, pDescr, td4one, td4due);
      //Modal creator
      //Button Modal
      //let btnModal = document.createElement("button");
...
Promise.all([
  fetch("https://api.punkapi.com/v2/beers?page=1&per_page=20", method),
  fetch("https://api.punkapi.com/v2/beers?page=2&per_page=20", method),
  fetch("https://api.punkapi.com/v2/beers?page=3&per_page=20", method),
  fetch("https://api.punkapi.com/v2/beers?page=4&per_page=20", method),
  fetch("https://api.punkapi.com/v2/beers?page=5&per_page=20", method),
])
